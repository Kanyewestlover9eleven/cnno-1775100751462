...
const basePath = '/cnno-1775100751462';
...
export default function Home() {
  ...
  const products = [{ n: 'Product 1', d: 'OG Rolls: Our classic sweet rolls, soft, fluffy, and full of love. Made with a special touch, these rolls are the perfect treat to brighten up your day.', icon: 'domain' }, { n: 'Product 2', d: 'Pistachio Rolls: A unique twist on our classic recipe, infused with the nutty flavor of pistachios. Perfect for those looking to try something new and exciting.', icon: 'architecture' }, { n: 'Product 3', d: 'Chocolate Rolls: For all the chocolate lovers out there, our chocolate rolls are a dream come true. Rich, decadent, and utterly irresistible.', icon: 'chair' }, { n: 'Product 4', d: 'Baby Rolls: Bite-sized versions of our classic sweet rolls, perfect for little hands or as a snack on-the-go. Cute, delicious, and fun to eat.', icon: 'eco' }, { n: 'Product 5', d: 'Party Box: Can\'t choose just one flavor? Our Party Box is the perfect solution. Featuring a selection of our signature rolls, it\'s ideal for special occasions, gatherings, or just because.', icon: 'precision_manufacturing' }];
      ...
      <section id="about" className="py-24 bg-surface">
        <div className="max-w-7xl mx-auto px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            ...
            <div><h4 className="font-bold text-primary">Mission</h4><p className="text-sm text-on-surface-variant">To craft high-quality, delicious sweet rolls that inspire connection and warmth, while building a community that shares our passion for the simple pleasures in life.</p></div>
